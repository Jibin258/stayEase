    ...
    return (
        <div className='bg-white text-black px-[3rem] md:px-[8rem] pb-[3rem] pt-[8rem]'>
            ...
            <div className='flex justify-center pb-8'>
                <img src={publicUrl + "assets/img/blog/blog_img2.webp"} alt={`Blog_Image`} className="h-[35vh] md:w-[60vw] md:h-[70vh] mt-5" />
            </div>
            ...
            <div className='flex gap-8'>
                ...
                <div><Link to="https://www.linkedin.com/feed/?linkOrigin=LI_BADGE&shareActive=true&shareUrl=https%3A%2F%2Fwww.mystayease.com%2Fpost%2Ftop-benefits-of-co-living-or-sharing-accommodation-for-millennials-in-bangalore" title="LinkedIn"><i className="text-lg fab fa-linkedin" /></Link></div>
                <div><Link to="https://www.pinterest.com/pin/create/button/?url=https://www.mystayease.com/post/top-benefits-of-co-living-or-sharing-accommodation-for-millennials-in-bangalore" title="Pinterest"><i className="text-lg fab fa-pinterest" /></Link></div>
                <div><Link to="https://x.com/intent/post?url=https%3A%2F%2Fwww.mystayease.com%2Fpost%2Ftop-benefits-of-co-living-or-sharing-accommodation-for-millennials-in-bangalore" title="Twitter"><i className="text-lg fab fa-twitter" /></Link></div>
            </div>
        </div>
    )
}
